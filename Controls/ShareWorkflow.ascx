<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ShareWorkflow.ascx.cs" Inherits="RockWeb.Blocks.Utility.ShareWorkflow" %>
        ...
        <asp:Panel ID="pnlView" runat="server" CssClass="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <Rock:FileUploader ID="fuImport" runat="server" Label="File" />
